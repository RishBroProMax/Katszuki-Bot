# Written by Inukaasith for Maxrobot
...
from Katszuki.modules.helper_funcs.chat_status import bot_admin, user_admin
from Katszuki.modules.helper_funcs.extraction import extract_user_and_text
...
def tagall(update, context):
    ...
    if tagall:
        ...
        message.reply_text("🤷‍♂️ Tagall list is empty!")
