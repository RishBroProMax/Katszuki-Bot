...
from Katszuki import telethn as bot
from Katszuki.modules.urluploader import download_file
from Katszuki.utils.uputils import humanbytes, progress
...
async def tsh(event):
    if event.reply_to_msg_id:
        ...
        try:
            ...
            traceback.print_exc()
            print(e)
            await event.respond(f"❌ Downloading Failed\n\n Report Now @EmoBotSupport Or @KatszukiSupport\n**Error:** {e}")
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @Katszuki_Bot  ❤",
            )
        except Exception as e:
            traceback.print_exc()
