...
from Katszuki import DRAGONS, JOIN_LOGGER, LOGGER, SUPPORT_CHAT, dispatcher
from Katszuki.modules.disable import DisableAbleCommandHandler
from Katszuki.modules.helper_funcs.chat_status import connection_status, user_admin
from Katszuki.modules.helper_funcs.handlers import MessageHandlerChecker
from Katszuki.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Katszuki.modules.helper_funcs.msg_types import get_note_type
from Katszuki.modules.helper_funcs.string_handling import escape_invalid_curly_brackets
...
def clear(update: Update, context: CallbackContext):
    ...
    if len(args) >= 1:
        ...
        if sql.rm_note(chat_id, notename):
            ...
            update.effective_message.reply_text("🤷‍♂️ That's not a note in my database!")
