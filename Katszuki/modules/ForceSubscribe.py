...
from Katszuki import DRAGONS as SUDO_USERS
from Katszuki import pbot
from Katszuki.modules.sql import forceSubscribe_sql as sql
            ...
            try:
                ...
                try:
                    sent_message = message.reply_text(
                        "Welcome {} 🙏 \n **You havent joined our @{} Channel yet** 😭 \n \nPlease Join [Our Channel](https://t.me/about_tosuu) and hit the **UNMUTE ME** Button And You Wan't Join @nothig_bots_support . සාදරයෙන් පිළිගනිමු {} 🙏 \n **ඔබ තවමත් අපේ  @{} Chanel හා සම්බන්ධ වී නැත** 😭 \n \nකරුණාකර අපේ නාලිකාවට සම්බන්ධ වී [Our Channel](https://t.me/about_tosuu) **UNMUTE ME** බොත්තම ඔබන්න. ".format(
        ...
        if len(message.command) > 1:
            ...
            if input_str.lower() in ("off", "no", "disable"):
                ...
                try:
                    ...
                    message.reply_text(
                        f"✅ **Force Subscribe is Enabled**\n__Force Subscribe is enabled, all the group members have to subscribe this [channel](https://t.me/KatszukiNews) in order to send messages in this group.__",
                        disable_web_page_preview=True,
                    )
                except UserNotParticipant:
                    message.reply_text(
                        f"❗ **Not an Admin in the Channel**\n__I am not an admin in the [channel](https://t.me/KatszukiNews). Add me as a admin in order to enable ForceSubscribe.__",
                        disable_web_page_preview=True,
                    )
