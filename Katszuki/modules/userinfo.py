...
import katszuki.modules.sql.userinfo_sql as sql
from katszuki import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
    INFOPIC,
...
from katszuki import telethn as SaitamaTelethonClient
from katszuki.__main__ import STATS, TOKEN, USER_INFO
from katszuki.modules.disable import DisableAbleCommandHandler
from katszuki.modules.helper_funcs.chat_status import sudo_plus
from katszuki.modules.helper_funcs.extraction import extract_user
from katszuki.modules.sql.afk_sql import check_afk_status, is_afk
from katszuki.modules.sql.global_bans_sql import is_user_gbanned
from katszuki.modules.sql.users_sql import get_user_num_chats
...
Examples:
 `/setme I am a wolf.`
 `/me @ImRishmika (defaults to yours if no user specified)`
